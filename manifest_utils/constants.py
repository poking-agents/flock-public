MODELS = (
    ...
    ("openrouter/qwen/qwen-2-72b-instruct", "qwen-2-72b", 16_000),
    ("openrouter/qwen/qwen-2.5-72b-instruct", "qwen-2.5-72b", 16_000),
    ("openrouter/qwen/qwen3-235b-a22b", "qwen3-235b-a22b", 16_000),
)
