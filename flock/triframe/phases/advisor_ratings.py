...
from flock.triframe.functions import (
    get_rating_function,
    validate_triframe_function_call,
)
from flock.triframe.logging import (
    create_log_request,
    log_actor_choice,
    log_styles,
)
from flock.triframe.phases.advisor import tool_output_with_usage
from flock.triframe.templates import (
    fn_comparison_template_end,
    fn_comparison_template_start,
)
from flock.type_defs import Node, Option
...
if __name__ == "__main__":
    run_phase(
        "advisor_ratings", create_phase_request, "flock.type_defs.states.triframeState"
    )
