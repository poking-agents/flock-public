...
def run_viv_commands(
    ...
    for task in task_names:
        for pack in agent_settings_packs:
            command = f"viv run {task} --agent_settings_pack {pack} --batch_name {batch_name} --max_tokens 200000000"
...
if __name__ == "__main__":
    ...
    # Run the commands
    run_viv_commands(FIRST_BATCH, settings_packs, batch_name="test_triframe_2")
